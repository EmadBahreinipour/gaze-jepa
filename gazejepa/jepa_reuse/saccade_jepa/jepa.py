# Vendored from https://github.com/LumenPallidium/jepa @ commit 22279b0
# ("adding updates from secret project"). Bare imports converted to relative
# imports so the file works as part of the gazejepa.jepa_reuse.saccade_jepa
# subpackage; otherwise unmodified.
import torch
import einops
import numpy as np
...
try:
    ...
    ET_AVAILABLE = False
    # EnergyTransformer is an optional upstream dependency we don't use; silence
    # the upstream's print so imports stay quiet.
    pass
